...
**AI / Full-Stack Engineer** focused on Reinforcement Learning, intelligent agents, educational technology, and production systems.
...
>  
> Also, as you can probably tell from the chaos below… **I have a lot of interests.**  
...
## 🗺 Journey Overview (Beginning → Now)
...
| **Systems / OS** | Deep OSTEP work (paging, TLB, scheduling, memory) — mostly Gists | Serious nerd hours |
| **Current** | RL, agent skills, Claude Architect cert, AI coaching tools, DeFi/hackathon work | What I’m building toward |
...
|-------|----------------|
| Paging / multilevel page tables | Cheatsheet + `paging-multilevel-translate.py` walkthrough |
| TLB measurement homework | Ch 19 — timer precision, experiments, pitfalls |
| Paging (Ch 18) | Core formulas and notes |
| Malloc / free-space management | Best/First/Worst Fit, coalescing, fragmentation |
| Segmentation | Base/bounds → segments |
| Base-and-bounds automation | Scripted `relocation.py` runs |
| C/UNIX Memory API | `malloc`/`free`, stack vs heap |
| Virtual memory intro | Multiprogramming + address spaces |
| Lottery scheduling | Ch 9 — lottery + stride |
| MLFQ scheduler | Ch 8 simulator + traces |

→ Full list: **[gist.github.com/mfeinLearn](https://gist.github.com/mfeinLearn)**

---

### 🛠 Tech Stack (Across the Journey)

**Languages:** Python • TypeScript / JavaScript • C# • Java • Ruby • SQL • Shell  

**AI / ML:** Claude / Anthropic • PyTorch • LLMs • Reinforcement Learning • Prompt Engineering • Pydantic  

**Backend / Systems:** Node.js • .NET Microservices • Next.js • Prisma • PostgreSQL / Supabase • GitHub Actions • OS concepts (paging, TLB, scheduling, memory virtualization)  

**Web3 / Hackathons:** LI.FI · Aave · Uniswap · EIP-7702 · MeTTa · Fetch.ai Agentverse · Ethereum  

**Other:** Android / libGDX • Data Science (pandas, PySpark, Tableau) • System Design • Agent skills tooling

---

### 🔗 Connect & Explore

- **Start here:** the “Proud Of” table at the top  
- **All Repositories:** [github.com/mfeinLearn?tab=repositories](https://github.com/mfeinLearn?tab=repositories)  
- **Gists:** [gist.github.com/mfeinLearn](https://gist.github.com/mfeinLearn)  
